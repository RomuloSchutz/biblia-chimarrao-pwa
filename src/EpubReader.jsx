...
export default function EpubReader({ title, epubUrl, onBack }) {
  ...
  return <main className="dashboard epub-page">
    ...
    <section className="epub-panel">
      ...
      {!epubUrl ? <div className="epub-notice"><h3>Leitor preparado</h3><p>A leitura deste livro será habilitada quando o arquivo EPUB estiver revisado e o acesso digital estiver configurado. Nenhuma compra está sendo realizada nesta tela.</p></div> : <>
