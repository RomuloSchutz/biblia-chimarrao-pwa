...
export default function App() {
  ...
  if (screen === 'books' && user) {
    const books = [
      {title:'Bíblia + Chimarrão',sub:'365 encontros com Deus',kind:'Devocional diário 2027',cover:'devotional',image:'/1000777684.png',status:'Disponível no aplicativo',action:'Abrir devocional',open:()=>setScreen('devotional')},
      ...
      {title:'Entre a Cidade e o Silêncio',sub:'NASCE · CRESCE · VIVE',kind:'Trilogia em desenvolvimento',cover:'cidade',image:'/1000769250.jpg',status:'Em breve',action:'Projeto em desenvolvimento'}
    ]
