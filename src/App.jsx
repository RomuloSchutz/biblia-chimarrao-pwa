...
export default function App() {
  ...
  if (screen === 'books' && user) {
    const books = [
      ...
      {title:'Entre o Já e o Ainda Não',sub:'A Esperança Inabalável em um Mundo Acelerado',kind:'Tempo · Corpo · Alma · Espírito',cover:'ja',status:'Livro publicado',action:'Detalhes em breve'},
