...
export default function App() {
  ...
  if (screen === 'books' && user) {
    const books = [
      {title:'Bíblia + Chimarrão',sub:'365 encontros com Deus',kind:'Devocional diário 2027',cover:'devotional',image:'/image.png',status:'Disponível no aplicativo',group:'disponivel',action:'Abrir devocional',open:()=>setScreen('devotional')},
      {title:'Entre os Tempos',sub:'A Urgência de Compreender o Calendário de Deus',kind:'História · Filosofia · Teologia',cover:'tempos',image:'/1000769251.jpg',status:'Livro publicado · leitura digital em preparação',group:'publicados',action:'Leitura digital em preparação'},
